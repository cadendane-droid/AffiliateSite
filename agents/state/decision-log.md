...
## 2026-07-22 · 04-seo · 2026-07-22-seo · D-004
- **Decision:** Second SEO run. Continued the D-003 hold: registered ZERO new experiments, evaluated zero (`active`=[]). Snapshot written to `metrics-snapshots/2026-07-22.json`.
- **Why:** 7-day window (2026-07-16..22) shows 5 total article_views (trekking-pole-tents 2; water-filters, canister-stoves, how-to-fit-a-backpack 1 each; sleeping-bag-ratings 0), 0 affiliate_click, 0 email_signup — all `$virt_traffic_type=Regular`, still QA/dev traffic. Peak article is 2 views vs the L-008 ≥200/arm floor. Baselining any experiment today would fabricate a degenerate baseline (L-008, anti-force-output doctrine). No page has ≥2 weeks of declining history, so no content-refresh "decaying page" target exists. Monthly external research already done this month (2026-07-21, learnings L-010/L-011), so none due today.
- **Desired result:** Same trigger as D-003 — first experiment registers only when an article reaches ≥200 article_views in a 7-day window. Review folds into D-003's 2026-08-04 checkpoint.
- **Review:** pending
